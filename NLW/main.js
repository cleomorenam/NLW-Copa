    ...
    <main id="cards">
      ...
      ${createCard(
        ...
        createGame("argentina", "07:00", "saudiarabia") +
          ...
          createGame("france", "16:00", "newzealand")
      )}
      ${createCard(
        "23/11",
        "quarta",
        createGame("morrocco", "07:00", "croacia") +
      ...
      ${createCard(
        "26/11",
        "sábado",
        createGame("tunisia", "07:00", "newzealand") +
      ...
      ${createCard(
        ...
        createGame("tunisia", "12:00", "france") +
          createGame("newzealand", "12:00", "denmark") +
      ...
      ${createCard(
        "01/12",
        "quinta",
        createGame("croacia", "12:00", "belgium") +
          createGame("canada", "12:00", "morrocco") +
